...
public class PlayerController : MonoBehaviour
{
    ...
    public bool AnimatorComponent = false; 
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.CompareTag("DialogueStart"))
        {
            ...
            //Animator = false;
            //Global.moving = false;
            //animAlythea.SetFloat("VelX", 0);
            //animAlythea.SetFloat("VelY", 0);
            //animIR.SetFloat("VelX", 0);
            //animIR.SetFloat("VelY", 0);

            //animAlythea.GetComponent<Animator>().enabled = false;
